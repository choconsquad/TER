...
local _M =
{
	...
	telegram =
	{
		token = "453358375:AAEGOO6b6PI1xCt0rn8trVEVW-ZA5rftyW4",
	...
	log =
	{
		chat = 285275696, 'You must export $LOG_CHAT with the numerical ID of the log chat'),
		admin = 373398727, 'You must export $LOG_ADMIN with your Telegram ID'),
		stats = os.getenv('LOG_STATS')
	},
	superadmins = 373398727,
